...
*/
    ...
    public CameraFilter(Context context,float[] ROTATED_TEXTURE_MATRIX,float[] TEXTURE_COORDS) {
        ...
        if (ROATED_TEXTURE_COORD_BUF == null) {
            ROATED_TEXTURE_COORD_BUF = ByteBuffer.allocateDirect(ROTATED_TEXTURE_MATRIX.length * 4)
                    .order(ByteOrder.nativeOrder()).asFloatBuffer();
            ROATED_TEXTURE_COORD_BUF.put(ROTATED_TEXTURE_MATRIX);
