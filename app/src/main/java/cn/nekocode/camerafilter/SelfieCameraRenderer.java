 ...
 */
public class SelfieCameraRenderer implements Runnable, TextureView.SurfaceTextureListener {
    ...
    public SelfieCameraRenderer(Context context) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        final int backCameraId = frontCamera.second;
